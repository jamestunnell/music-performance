...
describe ValueComputer do
  describe '#value_at' do
    ...
    context "constant value" do
      before :each do
        @comp = ValueComputer.new Profile.new(0.5)
      end
    ...
    context "one change, no transition" do
      before :each do
        profile = Profile.new(0.5, 1.0 => @value_change1)
    ...
    #  before :each do
    #    profile = Profile.new(0.2, 1.0 => @value_change2)
    #    @comp = ValueComputer.new profile
    #  end
    #  
    ...
    context "one change, sigmoid transition" do
      before :all do
        ...
        @cases.each do |case_hash|
          ...
          profile = Profile.new(start_value, offset => change)
          @computers[case_hash] = ValueComputer.new profile
